...
def save_bottlebeck_features():
    ...
    model.add(Convolution2D(64, 3, 3, activation='relu', name='conv1_1', trainable=False,input_shape=(175,175,3)))
...
def train_top_model():
    ...
    model.compile(optimizer=SGD(lr=0.001, decay=1e-4, momentum=0.9), loss='categorical_crossentropy', metrics=['accuracy'])
    ...
    plt.savefig("accuracy graph for freeze top training")
